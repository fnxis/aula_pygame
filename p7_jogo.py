...
imagemNave = pygame.image.load("img/kuririn.png")
imagemAsteroide = pygame.image.load("img/majinboo.png")
imagemRaio = pygame.image.load("img/kienzan.png")
imagemFundo = pygame.image.load("img/torneio.png")  
...
# Configurando o som.
somFinal = pygame.mixer.Sound("mp3/tp1.mp3")
somRecorde = pygame.mixer.Sound("mp3/recorde1.mp3")
somTiro = pygame.mixer.Sound("mp3/kiblast.mp3")
